#############################################################################
# Makefile for building: bongacoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Apr 18 22:54:12 2018
# Project:  bongacoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile bongacoin-qt.pro
#############################################################################
...
Makefile: bongacoin-qt.pro  c:/Qt/4.8.6/mkspecs/default/qmake.conf c:/Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile bongacoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) J:/BONGACOIN/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) J:/BONGACOIN/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
J:/BONGACOIN/src/leveldb/libleveldb.a: FORCE
	cd J:/BONGACOIN/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && ranlib J:/BONGACOIN/src/leveldb/libleveldb.a && ranlib J:/BONGACOIN/src/leveldb/libmemenv.a
