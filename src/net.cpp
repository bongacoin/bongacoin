...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bongacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bongacoin.net", "162.212.158.58"},
	{"bongacoin.com", "162.212.158.6"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"bongacointools.com", "testnet-seed.bongacointools.com"},
    {"bongacoin.org", "testnet-seed.bongacoin.org"},   
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bongacoin is probably already running."), addrBind.ToString().c_str());
        else
